...
public class MyCanvas extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String a ="4602105.30382905";
        String b ="41548044.8686187";
        String c ="41520988.4849743";
        String d ="4625724.82953126";
        //drawLine(Float.valueOf(a),Float.valueOf(b),Float.valueOf(c),Float.valueOf(d));
        //drawAL(Integer.parseInt(a),Integer.parseInt(b),Integer.parseInt(c),Integer.parseInt(d));//需要画什么就调相应的方法
        drawAL(0,0,100,100);
